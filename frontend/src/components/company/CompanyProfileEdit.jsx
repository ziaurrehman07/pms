          ...
          <table className="w-full mt-3">
            <tbody>
              <tr>
                ...
                <td className="font-semibold text-sm p-1">{companies.name}</td>
              </tr>
              <tr>
                <td className="font-semibold text-sm p-1 whitespace-nowrap">
                  Email :
                </td>
                <td className="font-semibold text-sm p-1">{companies.email}</td>
              </tr>
              <tr>
                <td className="font-semibold text-sm p-1 whitespace-nowrap">
                  Website :
                ...
                <td className="font-semibold text-blue-500 text-sm p-1 hover:underline">
                  <a href={companies.website} target="_blank" rel="noreferrer" className="hover:underline">
                    Visit Us
                  </a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="font-semibold text-sm p-1">{companies.address}</td>
              </tr>
            </tbody>
          </table>
        </div>
